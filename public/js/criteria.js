...
exports.default = {
    ...
    methods: {
        ...
        modalApply: function modalApply() {
            ...
            jQuery('#selectionModal').modal('hide');
        }
    },

    components: {
        Criterion: _Criterion2.default
    },
    ...
    events: {
        openSelectModal: function openSelectModal(options) {
            ...
            this.modal.selected = [];
            jQuery('#selectionModal').modal('show');
        },
